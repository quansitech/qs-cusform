...
declare const isField: (node: any) => node is Field<any, any, any, any>;
declare const isGeneralField: (node: any) => node is GeneralField;
declare const isArrayField: (node: any) => node is ArrayField<any, any>;
declare const isObjectField: (node: any) => node is ObjectField<any, any>;
declare const isVoidField: (node: any) => node is VoidField<any, any, any>;
declare const isFormState: (state: any) => state is IFormState<any>;
